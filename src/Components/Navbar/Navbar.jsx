...
//               <Link
//                 className="font-medium text-black dark:text-gray-400 dark:hover:text-gray-500 nav-text-data hover:text-red-600 nav-text-data"
//                 to="/about-us"
//               >
//                 About Us
//               </Link>
...
//                 >
//                   <Link
//                     className="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm  dark:text-gray-400 dark:hover:text-gray-500 nav-text-data hover:text-red-600 nav-text-data"
//                     to="/data-analytics"
//                   >
//                     Data Analytics
//                   </Link>
...
//               <Link
//                 className="font-medium text-black dark:text-gray-400 dark:hover:text-gray-500 nav-text-data hover:text-red-600"
//                 to="/contact-us"
//               >
//                 Contact Us
//               </Link>
...
// //         className=" relative flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white text-sm py-3 border-b-2">
// //         <nav
// //           className="w-full mx-auto px-7 sm:flex sm:items-center sm:justify-between h-10"
// //           aria-label="Global"
// //         >
// //           <div className="flex items-center justify-between">
// //             <Link
...
// //                 <div
// //                   className="hs-dropdown-menu transition-opacity duration-500 sm:duration-500 hs-dropdown-open:opacity-100 opacity-0 sm:w-48 hidden z-10 sm:mt-3 sm:shadow-md rounded-lg p-2 dark:bg-gray-800 sm:dark:border dark:border-gray-700 dark:divide-gray-700 before:absolute top-full sm:border before:-top-5 before:left-0 before:w-full before:h-5"
// //                   style={{ backgroundColor: "#fff" }}
// //                 >
// //                   <Link
